...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'FinancialServicesPage',
          path: '/financialServicesPage',
          builder: (context, params) => const FinancialServicesPageWidget(),
        ),
        FFRoute(
          name: 'WeatherInformation',
          path: '/weatherInformation',
          builder: (context, params) => const WeatherInformationWidget(),
        ),
        FFRoute(
          name: 'EducationalResources',
          path: '/educationalResources',
          builder: (context, params) => const EducationalResourcesWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/settingsandPreferences',
          builder: (context, params) => const SettingsandPreferencesWidget(),
        )
